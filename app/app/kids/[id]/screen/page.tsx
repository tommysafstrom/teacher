...
const FIELD_CONFIG: Record<Field, {
  ...
  1: {
    ...
    checkedBg: "bg-red-100 dark:bg-red-900/30",
  ...
  2: {
    ...
    checkedBg: "bg-amber-100 dark:bg-amber-900/30",
  ...
  3: {
    ...
    checkedBg: "bg-green-100 dark:bg-green-900/30",
  ...
  4: {
    ...
    checkedBg: "bg-blue-100 dark:bg-blue-900/30",
...
export default function ScreenPage() {
  ...
  return (
    <div className="max-w-2xl">
      ...
      {/* Legend */}
      <div className="flex flex-wrap gap-3 mb-8 p-3 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
      ...
      <div className="mt-8 flex items-center gap-4">
        <button
          ...
          disabled={submitting}
          className="bg-gray-800 dark:bg-gray-600 text-white px-6 py-2 rounded hover:bg-gray-900 dark:hover:bg-gray-500 disabled:opacity-40 disabled:cursor-not-allowed transition font-medium text-sm"
        >
